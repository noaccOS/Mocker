...
## Data definition
As of now, Mocker supports numbers (only integers), strings, booleans, dates, given names, family names, and a couple custom enums I made for my project (marks and days). All the data definition is index-based, the code has no knowledge whatsoever of the field names.
